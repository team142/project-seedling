...
const AuthMiddlewareTemplate = `//Package {{.Package}} code generated by team142
...
func AuthMiddleware(db *sql.DB, params []string) fiber.Handler {
	...
	*/
	...
	return func(c *fiber.Ctx) error {
		...
		exec, err := db.Exec({{.Backtick}}SELECT u.id AS user_id, r.role_name
		FROM users u
...
const StructValidationMiddlewareTemplate = `//Package {{.Package}} code generated by team142
