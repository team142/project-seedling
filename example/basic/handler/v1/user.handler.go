...
/*
	{Backtick: TypeSpec:0xc000008228 Fields:[{Field:0xc000026340 Rules:[] Name:Id APIName:id VarName:id Type:int PrimaryKey:true Ignore:false Tag:json:"id,omitempty"} {Field:0xc000026380 Rules:[] Name:FirstName APIName:first_name VarName:firstName Type:string PrimaryKey:false Ignore:false Tag:json:"first_name,omitempty"} {Field:0xc000026400 Rules:[] Name:LastName APIName:last_name VarName:lastName Type:string PrimaryKey:false Ignore:false Tag:json:"last_name,omitempty"}] Ignored:false Version:V1 APIPath:/ PrimaryKeys:[{Field:0xc000026340 Rules:[] Name:Id APIName:id VarName:id Type:int PrimaryKey:true Ignore:false Tag:json:"id,omitempty"}] PrimaryKeyCount:1 Struct:{APIName:user Name:User VarName:user Package:basic PackageImportPath:code-gen/example/basic MiddlewareImportPath:code-gen/example/basic/middleware/v1 PresenterImportPath:code-gen/example/basic/presenter/v1 HandlerImportPath:code-gen/example/basic/handler/v1} Module:code-gen Package:handler IntermediaryPath:example/basic Auth:false}
*/

/*
	We use the *sql.DB, although you can change this to *sql.TX if your process requires a transaction
	{ 0xc000008228 [{0xc000026340 [] Id id id int true false json:"id,omitempty"} {0xc000026380 [] FirstName first_name firstName string false false json:"first_name,omitempty"} {0xc000026400 [] LastName last_name lastName string false false json:"last_name,omitempty"}] false V1 / [{0xc000026340 [] Id id id int true false json:"id,omitempty"}] 1 {user User user basic code-gen/example/basic code-gen/example/basic/middleware/v1 code-gen/example/basic/presenter/v1 code-gen/example/basic/handler/v1} code-gen handler example/basic false}
*/
...
// GetUserByPrimaryKey get a single `basic.User` by the `basic.User.Id`
...
func GetUserByPrimaryKey(db *sql.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		var err error
		user := getUser(c)
...
// DeleteUserByPrimaryKey deletes a user
...
// @Param            id 			query      int     	false  "Id"
func DeleteUserByPrimaryKey(db *sql.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		var err error
		...
		userCore.Id, err = strconv.Atoi(c.Params("id", ""))
		if err != nil {
